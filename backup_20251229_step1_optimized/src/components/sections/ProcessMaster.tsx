    ...
    return (
      <section className="relative w-full bg-black py-20 px-6">
        ...
        <div className="max-w-[1400px] mx-auto mb-12 text-center">
          <h1 className="text-4xl sm:text-5xl font-normal tracking-tighter bg-clip-text text-transparent bg-gradient-to-b from-white to-[#E0CCFA]/70 leading-[0.9]">
            {t("headline")}
          </h1>
        </div>
