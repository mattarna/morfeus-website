  ...
  return (
    <section className="relative min-h-screen lg:h-screen w-full flex items-center justify-center bg-black overflow-hidden px-6 py-20 lg:py-0">
      ...
      >
        ...
        <h1 className="text-5xl sm:text-6xl md:text-8xl font-semibold tracking-tighter text-white leading-[0.95] mb-8 uppercase drop-shadow-[0_0_60px_rgba(77,57,235,0.3)]">
          {t("headline_1")}
          <br />
          {t("headline_2")}
        </h1>
