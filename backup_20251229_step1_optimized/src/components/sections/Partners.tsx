 ...
 */
const PARTNERS = [
  { name: "FeatherDev", icon: "solar:code-scan-linear", iconColor: "text-green-500", uppercase: false },
  { name: "Figma", icon: "simple-icons:figma", iconColor: "", uppercase: false },
  { name: "Gumroad", icon: "simple-icons:gumroad", iconColor: "", uppercase: true },
  { name: "Amplitude", icon: "simple-icons:amplitude", iconColor: "", uppercase: false },
  { name: "GlobalBank", icon: "solar:globus-linear", iconColor: "text-blue-500", uppercase: false },
  { name: "coinbase", icon: "simple-icons:coinbase", iconColor: "", uppercase: false },
  { name: "_zapier", icon: "simple-icons:zapier", iconColor: "text-[#FF4F00]", uppercase: false },
] as const;
      ...
      {partners.map((partner) => (
        ...
        >
          <Icon 
            ...
            className={(partner.iconColor as string) || "text-slate-300 group-hover:text-white transition-colors"}
          />
