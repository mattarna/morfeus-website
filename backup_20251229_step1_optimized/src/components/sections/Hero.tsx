    ...
    <section className="relative min-h-screen lg:h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-transparent py-20 lg:py-0">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6">
        ...
        <div className="flex flex-col items-center text-center space-y-[-0.2em] max-w-6xl mx-auto">
          <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl bg-clip-text leading-[0.9] font-semibold text-transparent tracking-tighter bg-gradient-to-b from-white via-white to-white/40 pb-2 uppercase">
            {t("headline_1")}
          </h1>
          <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl leading-[0.9] font-semibold text-white tracking-tighter pb-2 drop-shadow-[0_0_40px_rgba(255,255,255,0.15)] uppercase">
            {t("headline_2")}
          </h1>
          <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl bg-clip-text leading-[0.9] font-semibold text-transparent tracking-tighter bg-gradient-to-t from-white via-white to-white/40 uppercase">
            {t("headline_3")}
          </h1>
        </div>
