...
**[Scala prezzo — riga sotto, più piccola]**

```
67€ early bird (24h) → 97€ (giorni 2-7) → 147€ prezzo pieno
```

**Note regia:** Dark background (#0B0B0C). Timer countdown reale nel badge. Headline in Clash Display 600, grande. "Sistema completo" in Playfair Italic arancione. Proof bar con divider sottile. CTA bottone pieno arancione (#EB7A2E), centrato. Mobile: headline 2-3 righe, proof bar impilata, bottone full-width.

---

## BLOCCO 2 — DA WEBINAR A DECISIONE
...
**Note regia:** Testo centrato, colonna stretta (max 600px). Le tre righe "Hai visto..." con accento visivo (linea arancione verticale a sx, stile blockquote). Ampio respiro tra righe. Nessuna CTA qui — scorre nella sezione successiva.

---

## BLOCCO 3 — PROBLEMA RAPIDO + COSTO DEL NON AGIRE
...
**[Dato concreto — box evidenziato]**

```
Ogni settimana senza un sistema = 5-8 ore perse.
A 25€/ora, sono 500-800€ al mese.
Il corso ne costa 67.
```

**Note regia:** Il box "dato concreto" con bordo arancione sottile, sfondo leggermente più chiaro (#0F0E1A). Numeri in grande (Clash Display). Il body in Satoshi 400. Tono: non drammatico, fattuale. Il dolore è nel calcolo, non nell'emozione.
...
**Note regia:** I 3 step con icone numerate o card separate su sfondo leggermente più chiaro. Ogni step ha il titolo in Clash Display e il body in Satoshi. "Effetti collaterali" come sotto-blocco con frecce arancioni (→), tono leggermente più leggero — è un momento di respiro prima della sezione pesante successiva.
...
**[Moduli — formato card/lista con outcome]**
...
**Note regia:** Ogni modulo come card separata su sfondo #0F0E1A con bordo sottile. Numero del modulo in Clash Display arancione, grande. Titolo in Clash Display bianco. Descrizione in Satoshi 400. Layout: 2 colonne su desktop, 1 su mobile. La chiusura sezione centrata sotto le card.
...
```
[LOGHI: HFarm | Talent Garden | Sole 24 Ore | Confcommercio | Asseprim]
```

**[Testimonianze — 2-3 se disponibili]**

```
[TESTIMONIANZA 1 — con nome, ruolo, foto se possibile]
...
**Note regia:** Sezione a due colonne: testo authority a sx, logo wall a dx. Testimonianze sotto, full-width, con sfondo leggermente diverso (#1A1535). Foto testimonial round con bordo arancione. Tono authority: fattuale, nessuna esagerazione. I numeri parlano da soli.
...
**[Per chi È — lista con check arancione ✓]**
...
**[Per chi NON è — lista con X rossa ✗]**
...
**Note regia:** Due colonne su desktop: "Per chi è" a sx con check arancione, "Per chi NON è" a dx con X rossa. Mobile: una sotto l'altra. Sfondo "Per chi è" leggermente più caldo. Ogni item con spazio tra le righe. Il tono della colonna "NON è per te" non è escludente — è rispettoso ma chiaro.
...
**Note regia:** Tabella con tre colonne. Colonna "Corso Claude Morfeus" evidenziata con bordo arancione o sfondo leggermente diverso. Header delle colonne in Clash Display. Contenuto in Satoshi. Su mobile: trasformare in cards impilate (una per opzione) con i criteri come lista interna. La riga "Costo reale" è il colpo decisivo — evidenziarla.
...
**Note regia:** Questa è la sezione chiave. Ogni componente dello stack come card separata con valore dichiarato in arancione, allineato a destra. Il reveal del prezzo è teatrale: "67€" enorme in Clash Display arancione, centrato. La scala prezzo come barra visiva con indicatore "sei qui" lampeggiante o evidenziato. CTA grande, piena, arancione. Nota credito upgrade in box discreto sotto la CTA.
...
**[FAQ — formato accordion]**

```
"Non ho tempo di seguire un altro corso."

Capisco. Se lavori 8-10 ore al giorno, l'ultima cosa 
...
"Ho già provato ChatGPT/Claude e non mi ha impressionato."

Corretto. Se hai fatto domande e hai ottenuto risposte 
...
L'85% dei nostri studenti non ha alcun background tecnico.
...
"L'AI cambia troppo velocemente, tra 3 mesi è tutto diverso."

Se questo fosse un corso su UN tool specifico, 
avresti ragione.
...
"Perché Claude e non ChatGPT?"

Il corso insegna un metodo che funziona con qualsiasi AI.
...
"E se poi voglio fare il bootcamp?"
...
"Ho bisogno del piano a pagamento di Claude?"
...
**Note regia:** Formato accordion: click per espandere. Domanda in Clash Display bold. Risposta in Satoshi 400. Bordo sottile tra le FAQ. La prima FAQ ("non ho tempo") è aperta di default — è l'obiezione #1. Le altre chiuse. Su mobile: tutte chiuse, tap per espandere.
...
**[Timer countdown — visuale, grande]**
...
È il prezzo del webinar: riservato a chi era presente 
e decide di agire.
...
**[CTA — bottone arancione, pieno]**

```
Blocca il prezzo a 67€ — Entra adesso
```

**Note regia:** Timer countdown grande, centrato, numeri in Clash Display arancione su sfondo scuro con leggero glow. Le tre righe "non cambieranno" con dash arancione. CTA subito dopo il body, senza spazio. Il tono non è aggressivo — è fattuale. L'urgenza è nel calcolo, non nella pressione.
...
**[CTA finale — bottone grande, arancione]**
...
**Note regia:** Recap con frecce arancioni (→), ogni riga un elemento. Il prezzo 67€ enorme, in arancione. CTA full-width su mobile. L'ultima frase è il callback alla headline dell'optin ("il 10%") — chiude l'arco narrativo dell'intero funnel. Non un addio drammatico — un fatto.

---

## BLOCCO 14 — SEZIONE B2B

**[Divider visivo — linea sottile]**
...
**Note regia:** Sezione separata con divider. Stile più leggero, tono corporate-friendly ma non formale. Bottone outline (non pieno) per differenziare dalla CTA principale. Link a Calendly o form contatto. 3-4 righe max — non è una mini-sales page B2B, è un invito.

---

## NOTE GENERALI SULLA PAGINA

**CTA distribuite:** Hero (#1), dopo l'offerta (#9), urgenza (#12), finale (#13). Quattro punti di conversione. Non di più.

**Lunghezza totale stimata:** ~2.500-3.000 parole. Per un corso a 67€ post-webinar, è la lunghezza giusta. Abbastanza per convincere chi esita, non troppo per annoiare chi è già pronto.

**Tono complessivo:** Collega competente che sa di cosa parla. Diretto, concreto, zero hype. I numeri parlano da soli. Le promesse sono specifiche e verificabili. Il mercato italiano richiede specificità e credibilità — non americanata.

**Filo narrativo optin → webinar → sales page:** "10%/90%" nell'optin → demo dei Livelli nel webinar → "Livello 1 → 4" e "sistema completo" nella sales page → "non essere tra il 95%" nella chiusura. Arco coerente.
