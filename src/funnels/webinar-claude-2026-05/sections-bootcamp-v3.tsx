...
const LIME_DARK = "#5E8A0D";
const LIME_DARK_SOFT_10 = "rgba(94,138,13,0.10)";
const LIME_DARK_SOFT_18 = "rgba(94,138,13,0.18)";
const LIME_DARK_BORDER_25 = "rgba(94,138,13,0.30)";
...
/** Variante Accent per sezioni cream — usa olive scuro per leggibilita' */
function AccentCream({ children }: { children: React.ReactNode }) {
  return (
    <span
      style={{
        fontFamily: "var(--font-italic)",
...
/** Variante SectionLabel per sezioni cream */
function SectionLabelCream({ children }: { children: React.ReactNode }) {
  return (
    <span
      style={{
        display: "inline-flex",
    ...
    >
      <span style={{ width: 24, height: 1, background: LIME_DARK, opacity: 0.5, flexShrink: 0 }} />
      {children}
    </span>
  );
}
    ...
    >
      <div style={{ maxWidth: 1080, margin: "0 auto" }}>
        <div style={{ marginBottom: 16 }}>
          <SectionLabelCream>Il problema che nessuno nomina</SectionLabelCream>
        </div>
        ...
        <div style={{ maxWidth: 720, fontFamily: "var(--font-body)", fontSize: 17, lineHeight: 1.65, color: CREAM_INK, opacity: 0.92 }}>
          ...
          <p style={{ margin: 0, color: LIME_DARK, fontWeight: 600 }}>Questo è il plateau L2. Ci finiscono quasi tutti.</p>
        </div>
        ...
        <div style={{ marginTop: 44, maxWidth: 720, fontFamily: "var(--font-body)", fontSize: 17, lineHeight: 1.65, color: CREAM_INK }}>
          ...
          <p style={{ margin: 0, fontWeight: 700, color: CREAM_INK }}>
        ...
        >
          ...
          <p style={{ margin: "0 0 6px", fontFamily: "var(--font-body)", fontSize: 16, lineHeight: 1.55, color: CREAM_INK }}>
            È quello che spendi a fare da solo il salto da L2 a L3.
          </p>
          <p style={{ margin: 0, fontFamily: "var(--font-italic)", fontStyle: "italic", fontSize: 14, lineHeight: 1.55, color: CREAM_INK_SOFT }}>
        ...
        >
          ...
          <span style={{ color: LIME_DARK, fontWeight: 600, textDecoration: "underline" }}>vai diretto all&apos;offerta ↓</span>
        </p>
      </div>
    </section>
  );
...
function LevelCard({
  ...
  return (
    <div
      style={{
        background: CREAM_CARD,
        border: `1px solid ${highlight ? LIME_DARK : CREAM_HAIRLINE}`,
        borderRadius: 14,
        padding: 22,
        position: "relative",
        boxShadow: highlight ? `0 12px 40px ${LIME_DARK_SOFT_18}` : "none",
      }}
    >
      ...
      <p style={{ margin: 0, fontFamily: "var(--font-body)", fontSize: 14, lineHeight: 1.55, color: CREAM_INK, opacity: 0.85 }}>
        {body}
      </p>
      {badge && (
        <span
          style={{
            ...
            padding: "5px 12px",
            borderRadius: 100,
            background: highlight ? LIME_DARK : "rgba(15,15,26,0.06)",
            color: highlight ? "#fff" : CREAM_INK_SOFT,
            fontFamily: "var(--font-body)",
            fontSize: 11,
            fontWeight: 700,
...
export function BootcampV3MethodSection({ step }: SectionProps) {
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1080, margin: "0 auto" }}>
        <div style={{ marginBottom: 14, textAlign: "center" }}>
          <SectionLabelCream>Il motivo per cui funziona</SectionLabelCream>
        </div>
        ...
        >
          Non è un corso.
          <br />
          È un <AccentCream>metodo in tre fasi</AccentCream>.
        </h2>
        ...
        >
          Il bootcamp usa un metodo preciso. Si chiama <strong style={{ color: CREAM_INK }}>M-V-A</strong>.
        </p>
        ...
        <div className={styles.bootcampMvaGrid}>
          {steps.map((s) => (
            <div
              ...
              style={{
                background: CREAM_CARD,
                border: `1px solid ${CREAM_HAIRLINE}`,
                borderRadius: 16,
                padding: 28,
                display: "flex",
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 8 }}>
                <div
                  style={{
                    ...
                    fontWeight: 700,
                    fontSize: 26,
                    boxShadow: `0 8px 24px ${LIME_DARK_SOFT_18}`,
                    flexShrink: 0,
                  }}
                >
                  {s.letter}
                </div>
                <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 22, color: CREAM_INK, margin: 0, letterSpacing: "0.05em" }}>
                  {s.title}
                </h3>
              </div>
              {s.body.map((p, idx) => (
        ...
        <div
          style={{
            ...
            background: "rgba(94,138,13,0.06)",
            border: `1px solid ${LIME_DARK_BORDER_25}`,
            borderRadius: 16,
            maxWidth: 820,
            marginLeft: "auto",
        ...
        >
          ...
          <p style={{ margin: "0 0 12px", fontFamily: "var(--font-body)", fontSize: 16, lineHeight: 1.65, color: CREAM_INK, opacity: 0.92 }}>
          ...
          <p style={{ margin: 0, fontFamily: "var(--font-body)", fontSize: 16, lineHeight: 1.65, color: CREAM_INK, fontWeight: 700 }}>
        ...
        >
          Le alternative ti portano a <strong style={{ color: LIME_DARK }}>M</strong>.
          <br />
          Qualche volta a <strong style={{ color: LIME_DARK }}>V</strong>.
          <br />
          Il bootcamp ti porta ad <AccentCream>A</AccentCream>.
        </p>
...
function NumberStatCream({ big, label }: { big: string; label: string }) {
  return (
    <div>
      ...
      <p style={{ margin: "8px 0 0", fontFamily: "var(--font-body)", fontSize: 14, color: CREAM_INK, opacity: 0.85 }}>
        {label}
      </p>
    </div>
  );
...
export function BootcampV3ProgramSection() {
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1080, margin: "0 auto" }}>
        <div style={{ marginBottom: 14, textAlign: "center" }}>
          <SectionLabelCream>Il programma</SectionLabelCream>
        </div>
        ...
        >
          7 sessioni live.
          <br />
          <AccentCream>14 ore</AccentCream> di formazione reale.
          <br />
        ...
        >
          ...
          <p style={{ margin: 0, fontFamily: "var(--font-body)", fontSize: 16, color: CREAM_INK, lineHeight: 1.6 }}>
...
function FormatBullet({ icon, children }: { icon: string; children: React.ReactNode }) {
  return (
    <li style={{ display: "flex", gap: 12, fontFamily: "var(--font-body)", fontSize: 15, lineHeight: 1.55, color: CREAM_INK }}>
...
const bootcampReviews: BootcampV3Review[] = [
  {
    initials: "AG",
...
function ReviewCardCream({ initials, name, role, company, quote, rating }: BootcampV3Review) {
  return (
    <div
      style={{
        background: CREAM_CARD,
        ...
        height: "100%",
        boxSizing: "border-box",
        boxShadow: `0 12px 40px ${LIME_DARK_SOFT_10}`,
      }}
    >
      <div style={{ display: "inline-flex", gap: 4 }} aria-label={`${rating} stelle su 5`}>
        {Array.from({ length: 5 }).map((_, i) => (
          <svg
            ...
            height="20"
            viewBox="0 0 24 24"
            fill={i < rating ? LIME_DARK : "rgba(15,15,26,0.10)"}
            stroke={i < rating ? LIME_DARK : "rgba(15,15,26,0.18)"}
            strokeWidth="1.4"
            aria-hidden
          >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14, paddingTop: 16, borderTop: `1px solid ${CREAM_HAIRLINE}` }}>
        <span
          style={{
            width: 46,
            height: 46,
        ...
        <div style={{ minWidth: 0, flex: 1 }}>
          <div style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 16, color: CREAM_INK, lineHeight: 1.2 }}>
            {name}
          </div>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ marginBottom: 14, textAlign: "center" }}>
          <SectionLabelCream>La prova</SectionLabelCream>
        </div>
        ...
        >
          Cosa succede <AccentCream>davvero</AccentCream>
          <br />
          dopo il bootcamp
        </h2>
        ...
        >
          <NumberStatCream big="2.000+" label="professionisti formati da Morfeus Hub" />
          <NumberStatCream big="3" label="edizioni del bootcamp (questa è la terza)" />
          <NumberStatCream big="40+ → 25" label="edizioni precedenti ridotte per qualità" />
          <NumberStatCream big="60%+" label="partecipanti fuori da marketing e comunicazione" />
        </div>
        ...
        >
          ...
          <p style={{ margin: "0 0 12px", fontFamily: "var(--font-body)", fontSize: 16, lineHeight: 1.65, color: CREAM_INK }}>
          ...
          <p style={{ margin: "0 0 12px", fontFamily: "var(--font-body)", fontSize: 16, lineHeight: 1.65, color: CREAM_INK, opacity: 0.9 }}>
            Commerciali, avvocati, consulenti, manager HR, ingegneri, imprenditori, architetti.
          </p>
          <p style={{ margin: 0, fontFamily: "var(--font-body)", fontSize: 16, lineHeight: 1.65, color: CREAM_INK, opacity: 0.9 }}>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 920, margin: "0 auto" }}>
        <div style={{ marginBottom: 14, textAlign: "center" }}>
          <SectionLabelCream>Facciamo i conti</SectionLabelCream>
        </div>
        ...
        >
          <span style={{ color: LIME_DARK }}>1.397 euro.</span>
          <br />
          O <AccentCream>13.000 euro all&apos;anno</AccentCream>
          <br />
        ...
        >
          ...
          <p style={{ margin: 0, color: CREAM_INK, fontWeight: 700 }}>
        ...
        >
          <p style={{ margin: 0, fontFamily: "var(--font-display)", fontSize: "clamp(20px, 2.6vw, 24px)", fontWeight: 600, color: CREAM_INK, lineHeight: 1.3 }}>
            ...
            <span style={{ color: CREAM_INK_SOFT, fontFamily: "var(--font-italic)", fontStyle: "italic", fontWeight: 400, fontSize: 16, display: "block", marginTop: 6 }}>
        ...
        >
          ...
          <p style={{ margin: 0 }}>
            Non farlo costa <strong style={{ color: LIME_DARK }}>6.000-12.000 euro all&apos;anno</strong>, ogni anno, finché non costruisci il sistema.
          </p>
          <p style={{ margin: 0 }}>
        ...
        >
          Deducibile come formazione professionale. Costo netto dopo deducibilità (24%): <strong style={{ color: LIME_DARK }}>~{Math.round(pricing.currentPrice * 0.76).toLocaleString("it-IT")} EUR</strong>.
        </div>
...
function RoiScenario({ tier, label, yearly, payback }: { tier: string; label: string; yearly: string; payback: string }) {
  return (
    ...
    >
      <div>
        <p style={{ margin: 0, fontFamily: "var(--font-display)", fontSize: 22, fontWeight: 700, color: LIME_DARK, letterSpacing: "-0.01em" }}>
          {tier}
        </p>
        <p style={{ margin: "4px 0 0", fontFamily: "var(--font-body)", fontSize: 13, color: CREAM_INK_SOFT, lineHeight: 1.4 }}>
          {label}
        </p>
      </div>
      <div>
        ...
        <p style={{ margin: 0, fontFamily: "var(--font-body)", fontSize: 15, lineHeight: 1.55, color: CREAM_INK, opacity: 0.9 }}>
          {payback}
        </p>
      </div>
    </div>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 880, margin: "0 auto", textAlign: "center" }}>
        <div style={{ marginBottom: 14 }}>
          <SectionLabelCream>La nostra garanzia</SectionLabelCream>
        </div>
        ...
        >
          Investimento <AccentCream>protetto.</AccentCream>
          <br />
          Su due livelli.
        </h2>
...
function GuaranteeCard({ icon, title, body, primary }: { icon: string; title: string; body: string[]; primary?: boolean }) {
  return (
    <div
      style={{
        background: CREAM_CARD,
        border: `1px solid ${primary ? LIME_DARK_BORDER_25 : CREAM_HAIRLINE}`,
        borderRadius: 16,
        padding: "clamp(22px, 4vw, 30px)",
      }}
    >
      <div style={{ fontSize: 28, marginBottom: 14 }}>{icon}</div>
      <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 22, color: CREAM_INK, margin: "0 0 16px", lineHeight: 1.3 }}>
        {title}
      </h3>
      <div style={{ display: "grid", gap: 12 }}>
        {body.map((p, idx) => (
          <p key={idx} style={{ margin: 0, fontFamily: "var(--font-body)", fontSize: 16, lineHeight: 1.65, color: CREAM_INK, opacity: 0.9 }}>
            {p}
          </p>
        ))}
      </div>
