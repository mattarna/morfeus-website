# Modulo 01 — Le Nuove Regole dell'Infobusiness
...
| Durata | 76 min |
| Tags | mercato, ecosistema, 4 pilastri, personal brand, vendita, AI, cultura aziendale |

[Torna all'indice](../index.md) | [Modulo successivo →](./02-michele-offerte-conversione.md)
...
|--------|----------------|
| [02 - Michele](./02-michele-offerte-conversione.md) | L'asse Hormozi-Kennedy è lo strumento pratico per implementare l'elasticità al prezzo (Leva 1). Si inserisce nei pilastri 2 e 4 |
| [03 - Roberto](./03-roberto-war-machine.md) | La War Machine operazionalizza il Pilastro 2 (Liquidazione). La regola del lag 14 giorni risponde al problema del flusso di cassa |
| [04 - Federico](./04-federico-creativita-advertising.md) | Il Pilastro 3 (Lubrificazione) trova la sua tattica nelle creatività diversificate e nell'organico |
| [05 - Formula Partner](./05-formula-partner-incubatore.md) | Un modello alternativo di business che risolve il problema della struttura e del team |
| [06 - Simone](./06-simone-vendita-etica.md) | La fiducia come leva di conversione è il complemento etico della Leva 2 (vendita strutturata) |
| [07 - Michelangelo](./07-michelangelo-meta-ads.md) | Il framework operativo per gestire il Pilastro 1 (Acquisizione) su Meta |
