      ...
      >
        ...
        <div className="relative z-10" style={{ transform: "translateZ(50px)" }}>
          ...
          >
            ...
            />
            <div className="relative z-20 w-10 h-10 md:w-14 md:h-14 bg-linear-to-br from-violet-600 via-fuchsia-500 to-rose-500 rounded-xl flex items-center justify-center shadow-[0_0_40px_rgba(217,70,239,0.5)] rotate-45 border border-white/20">
