...
export function HomeHero() {
  ...
  return (
    <section className="relative min-h-svh xl:h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-transparent pt-28 pb-20 sm:pt-32 xl:py-0">
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center text-center px-5 sm:px-6 max-w-7xl mx-auto xl:-translate-y-4">
        ...
        <div className="flex flex-col items-center text-center max-w-7xl mx-auto w-full">
          {/* Corpo e larghezza tarati perche' "TROVIAMO DOVE PERDI MARGINE."
              stia su una riga sola da lg in su: cosi' la headline chiude in
              tre righe invece di quattro. */}
          <h1 className="text-[2.5rem] sm:text-[3.35rem] md:text-[4.15rem] lg:text-[3.65rem] xl:text-[clamp(3rem,8.2vh,4.75rem)] short:!text-[3.85rem] leading-[1.14] md:leading-[1.1] font-black tracking-tighter uppercase wrap-break-word w-full">
