...
export function AssetsSection() {
  ...
  return (
    <section id="assets" className="relative z-[80] py-24 md:py-40 px-6 xl:px-40 bg-[#0a111a] border-t border-white/[0.05] shadow-[inset_0_0_150px_rgba(0,0,0,0.6)] overflow-visible">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="w-14 h-14 rounded-2xl bg-[#030508] border border-white/10 flex items-center justify-center mb-8 shadow-xl transition-all duration-500 group-hover:scale-110 group-hover:border-indigo-500/30 relative">
                  <Icon icon={asset.icon} className="w-7 h-7 text-slate-400 transition-colors duration-500 group-hover:text-indigo-400" />
                  <div className="absolute -top-1 -right-1 w-1.5 h-1.5 rounded-full bg-forge shadow-[0_0_10px_#E8650A] opacity-70 group-hover:opacity-100 group-hover:shadow-[0_0_15px_#E8650A] transition-all duration-500" />
                </div>
              ...
              <div className="absolute bottom-0 left-0 w-0 h-[2px] bg-forge/60 transition-all duration-700 group-hover:w-full" />
            </div>
          ))}
        </div>
      </div>
