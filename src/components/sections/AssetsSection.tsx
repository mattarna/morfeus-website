...
export function AssetsSection() {
  ...
  return (
    <section id="assets" className="relative z-80 py-24 md:py-40 px-6 xl:px-40 bg-[#0a111a] border-t border-white/5 shadow-[inset_0_0_150px_rgba(0,0,0,0.6)] overflow-visible">
