...
export function ProblemSection() {
  ...
  return (
    <section id="problem" className="relative z-40 py-24 md:py-40 px-6 bg-[#0a111a] border-y border-white/5 shadow-[inset_0_0_150px_rgba(0,0,0,0.6)] overflow-visible">
      {/* Module ID Tag */}
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="mb-16 md:mb-24">
          <span className="inline-block text-[10px] font-mono text-indigo-500 tracking-[0.4em] uppercase mb-6 border border-indigo-500/30 px-3 py-1 rounded-sm">
            {t("problem.tag")}
          </span>
        ...
        <div className="bg-slate-900/20 rounded-2xl border border-white/5 overflow-hidden mb-20 md:mb-24">
          ...
          <div className="divide-y divide-white/5">
            {[1, 2, 3, 4, 5].map((i) => (
              <div 
                key={i} 
                className="group flex items-start gap-6 p-8 hover:bg-white/1 transition-colors"
              >
                <div className="mt-2.5 w-2 h-2 rounded-full bg-red-500/40 group-hover:bg-red-500 transition-colors shadow-[0_0_10px_rgba(239,68,68,0.3)] shrink-0" />
