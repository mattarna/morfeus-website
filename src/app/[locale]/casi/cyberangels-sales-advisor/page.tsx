...
export function generateMetadata({ params: { locale } }: Props): Metadata {
  ...
  return {
    ...
    openGraph: {
      ...
      description: t.metaDesc,
      type: "article",
      url: `${SITE_URL}/${safeLocale}/casi/cyberangels-sales-advisor`,
      siteName: "Morfeus",
...
export default function CyberangelsSalesAdvisorPage({ params: { locale } }: Props) {
  const isIt = locale === "it";
  const t = isIt ? COPY.it : COPY.en;
  const safeLocale: "it" | "en" = isIt ? "it" : "en";
  const base = `/${safeLocale}`;
  const pageUrl = `${SITE_URL}/${safeLocale}/casi/cyberangels-sales-advisor`;
