    ...
    <div className="relative min-h-screen w-full bg-[#030508] text-white overflow-x-hidden">
      ...
      >
        <div className="max-w-[1200px] w-full flex flex-col items-center text-center">
          ...
          <div className="mb-6 md:mb-8">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black tracking-[-0.03em] leading-[1.05] uppercase">
              <span 
          ...
          {/* 4. CTA */}
          <button className="on-page-cta group relative px-12 py-5 rounded-full font-bold text-sm uppercase tracking-[0.15em] transition-all duration-500 overflow-hidden shadow-[0_0_40px_-10px_rgba(79,70,229,0.5)]">
      ...
      <section id="filter" className="relative z-30 py-24 md:py-32 px-6 overflow-visible">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex flex-col items-center gap-10 border-t border-white/5 pt-12">
            ...
            <button className="on-page-cta group relative px-12 py-5 rounded-full border border-white/20 bg-white/5 hover:bg-white/10 hover:border-white/40 transition-all duration-500 shadow-[0_0_30px_-10px_rgba(255,255,255,0.1)] hover:shadow-[0_0_40px_-10px_rgba(255,255,255,0.2)]">
              ...
              <div className="relative h-full bg-[#0a0f14] border border-white/[0.08] rounded-3xl overflow-hidden transition-all duration-300 hover:border-white/20">
                ...
                <div className="px-8 py-10 space-y-10">
                  ...
                  <div>
                    ...
                    <button className="on-page-cta w-full py-5 rounded-xl border-2 border-white/10 bg-white/[0.03] text-base font-black uppercase tracking-[0.15em] text-slate-200 hover:bg-white/10 hover:border-white/30 hover:text-white transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.05)]">
                      {t("ctas.pricing")}
                    </button>
                  </div>
                </div>
              ...
              <div className="relative h-full bg-gradient-to-b from-[#0d1520] to-[#080c12] border border-indigo-500/30 rounded-3xl overflow-hidden shadow-[0_0_60px_-15px_rgba(79,70,229,0.3)]">
                ...
                <div className="px-8 py-10 space-y-10">
                  ...
                  <div>
                    ...
                    <button className="on-page-cta w-full py-5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-base font-black uppercase tracking-[0.15em] text-white shadow-[0_0_30px_rgba(6,182,212,0.4)] hover:shadow-[0_0_40px_rgba(6,182,212,0.6)] hover:scale-[1.02] transition-all duration-300">
                      {t("ctas.pricing")}
                    </button>
                  </div>
                </div>
            ...
            <div className="relative bg-gradient-to-b from-[#0d1520] to-[#080c12] border border-white/[0.08] rounded-3xl overflow-hidden">
              ...
              <div className="px-8 md:px-16 lg:px-24 py-16 md:py-20 lg:py-24">
                ...
                <div className="flex justify-center">
                  <button className="on-page-cta group relative px-12 md:px-16 py-5 md:py-6 rounded-full font-bold text-lg md:text-xl tracking-wide transition-all duration-500 overflow-hidden shadow-[0_0_50px_-10px_rgba(6,182,212,0.5)] hover:shadow-[0_0_80px_-10px_rgba(6,182,212,0.7)] hover:scale-105">
      ...
      <section id="faq" className="relative z-[120] py-24 md:py-40 px-6 bg-[#05070a] border-t border-white/[0.03] overflow-visible">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 px-4 py-1 bg-[#030303] border border-white/10 rounded-full z-[130]">
          <span className="text-[10px] font-mono text-slate-500 tracking-[0.3em] uppercase whitespace-nowrap">{t("faq_offerta.tag")}</span>
        </div>
                    ...
                    >
                      <div className="px-6 pb-6 md:pb-8 ml-0 md:ml-14">
                        ...
                        <p 
                          ...
                          dangerouslySetInnerHTML={{ 
                            __html: t(`faq_offerta.items.${index}.a`).replace(/\*\*(.*?)\*\*/g, '<strong class="text-slate-200 font-medium">$1</strong>') 
                          }} 
                        />
                      </div>
                    </div>
