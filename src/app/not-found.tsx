 ...
 * Global 404 Page
 * 
 * This page is displayed when a route doesn't match any locale or known path.
 * It inherits the HTML structure from the root layout.
 */
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6">
        ...
        <div className="space-y-4 mb-12">
          ...
          <p className="text-slate-400 text-base sm:text-lg max-w-md font-light">
            The page you&apos;re looking for has been unplugged from the Matrix.
          </p>
        </div>
