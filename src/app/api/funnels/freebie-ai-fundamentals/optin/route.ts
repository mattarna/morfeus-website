...
const DEFAULT_FORM_NAME = "Freebie_ai_fundamentals_giugno";
...
export async function POST(request: Request) {
  try {
    ...
    const freebieListId = getBrevoListId("FREEBIE_AI_FUNDAMENTALS_GIUGNO");
    ...
    console.error("freebie-ai-fundamentals optin failed", error);
