...
export async function POST(request: Request) {
  try {
    ...
    const listId = getBrevoListId("NEXT_WEBINAR_WAITLIST");
    ...
    const contactResponse = await fetch("https://api.brevo.com/v3/contacts", {
      ...
      body: JSON.stringify({
        ...
        attributes: {
          ...
          [BREVO_ATTR.FORM_NAME]: payload.source ?? "next-webinar-waitlist",
    ...
    console.error("next-webinar waitlist failed", error);
