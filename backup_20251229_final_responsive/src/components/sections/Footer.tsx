    ...
    <section className="relative min-h-screen lg:h-screen w-full bg-[#070711] flex flex-col justify-center overflow-hidden py-20 lg:py-0">
      ...
      >
        ...
        <div className="flex flex-col gap-6 md:gap-8 items-start md:items-end text-left md:text-right">
          <h4 className="text-[11px] uppercase tracking-[0.25em] text-[#9B8FD9] font-semibold">{t("branding")}</h4>
          
          <div className="flex flex-col gap-3 items-start md:items-end mt-2">
            <a href="mailto:info@morfeushub.com" className="text-white text-lg font-normal hover:text-[#9B8FD9] transition-colors">info@morfeushub.com</a>
            <p className="text-[11px] text-slate-500 font-mono tracking-wide">P.IVA 01234567890</p>
          </div>
          
          <div className="flex flex-col items-start md:items-end gap-1 mt-8">
...
/**
 * Simple modal for Terms & Privacy
 */
function LegalModal({ type, onClose }: { type: "terms" | "privacy"; onClose: () => void }) {
  ...
  return (
    ...
    >
      <div 
        className="relative max-w-2xl w-full bg-[#0a0a0f] border border-white/10 rounded-2xl p-8 md:p-12 max-h-[80vh] overflow-y-auto"
          ...
          <div className="text-slate-300 space-y-4 text-sm leading-relaxed">
            {type === "terms" ? (
              <>
                ...
                <p>
                  Welcome to Morfeus. By accessing and using our services, you agree to comply with and be bound by the following terms and conditions.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6">1. Use of Services</h3>
                <p>
                  Our AI consulting and implementation services are provided for professional business use. You agree to use our services in compliance with all applicable laws and regulations.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6">2. Intellectual Property</h3>
                <p>
                  All content, designs, and materials provided by Morfeus remain the intellectual property of Morfeus unless explicitly transferred under a separate agreement.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6">3. Limitation of Liability</h3>
                <p>
                  Morfeus provides services on an "as is" basis. We are not liable for indirect, incidental, or consequential damages arising from the use of our services.
                </p>
                <p className="mt-6 text-xs text-slate-500">
                  For complete terms and conditions, please contact us at info@morfeushub.com
                </p>
              </>
            ) : (
              <>
                ...
                <p>
                  At Morfeus, we take your privacy seriously. This policy outlines how we collect, use, and protect your personal information.
                </p>
                <h3 className="text-lg font-semibold text-white mt-6">1. Information We Collect</h3>
                <p>
                  We collect information you provide directly to us, such as when you request a consultation, including your name, email address, company information, and project requirements.
                </p>
                ...
                <h3 className="text-lg font-semibold text-white mt-6">4. Your Rights</h3>
                <p>
                  You have the right to access, correct, or delete your personal information. Contact us at info@morfeushub.com to exercise these rights.
                </p>
                <p className="mt-6 text-xs text-slate-500">
                  For our complete privacy policy, please contact us at info@morfeushub.com
                </p>
              </>
            )}
          </div>
