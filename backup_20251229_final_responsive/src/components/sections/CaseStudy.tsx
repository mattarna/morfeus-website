...
export function CaseStudy() {
  ...
  const caseStudies: CaseStudyData[] = [
    ...
    },
    {
      ...
      image: "https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/aebaf2b3-8102-48d1-99fa-48b238a6e13b_3840w.webp",
    },
  ];
    ...
    return (
      <section className="relative w-full bg-black py-20 px-6">
        ...
        <div className="max-w-[1400px] mx-auto mb-10">
          <span className="text-[10px] uppercase tracking-[0.25em] text-[#4D39EB] font-semibold">
            {t("label")}
          </span>
        </div>
        ...
        {caseStudies.map((cs, index) => (
          ...
          >
            ...
            <img
              src={cs.image}
              alt={cs.name}
              className={`w-full h-full object-cover grayscale-[30%] transition-all duration-1000 ${
